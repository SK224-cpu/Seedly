...
class DailyEntry:
    ...
    def __repr__(self):
        return f"DailyEntry(user_id={self.user_id}, task_id={self.task_id}, task_done={self.task_status}, timestamp={self.timestamp}, note={self.note}, task_completed={self.task_completed}, daily_entry_id={self.daily_entry_id})"
